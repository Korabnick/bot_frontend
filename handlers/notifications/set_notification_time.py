...
from core.buttons import CHANGE_NOTIFICATION_TIME, go_back_keyboard, get_main_keyboard
from handlers.notifications.router import notification_router
from states.calories import NotificationTimeState
from utils.request import do_request
from core.config import settings


@notification_router.message(F.text == CHANGE_NOTIFICATION_TIME)
